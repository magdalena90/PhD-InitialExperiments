...
cc_output = datExpr_redDim %>% as.matrix %>% t %>% ConsensusClusterPlus(maxK=10, reps=5, seed=123,
                                                   title='./../Data/Gandal/consensusClustering/probes_DE/l1', plot='png')
...
#   ConsensusClusterPlus(maxK=8, reps=50, seed=123, title='./../Data/Gandal/consensusClustering/probes_DE/l2_1/', plot='png')
...
#   ConsensusClusterPlus(maxK=8, reps=50, seed=123, title='./../Data/Gandal/consensusClustering/probes_DE/l2_2/', plot='png')
# load('./../Data/Gandal/consensusClustering/probes_DE/l2_2/cc_output.RData')
# best_k = 1 # No subclusters
...
knitr::include_graphics('./../Data/Gandal/consensusClustering/probes_DE/l1/consensus010.png')
```
