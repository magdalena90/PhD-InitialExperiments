...
Samples are grouped into two big clusters, one small, one of only six genes and two outliers, 
and two outliers, the first big cluster has three main subclusters, two small subclusters and two outliers, and the second one two main subclustersand five small subclusters.
...
load('clustering_genes_03_21/cc_l1/cc_output.RData')
best_k = 6 # 2 big clusters and 2 outliers
...
load('clustering_genes_03_21/cc_l2_1/cc_output.RData')
best_k = 3
...
load('clustering_genes_03_21/cc_l2_2/cc_output.RData')
best_k = 2
...
* Clusterings seem to give very different results, consensus clustering and k-mean resemble the manual separation
```{r}
