...
if(!file.exists('./../Data/Voineagu_normalised.RData')){
  
  # Download and load Microarray_ASD_Voineagu_normalized.RData
  datMeta$Disease.status = datMeta$A.C
  ...
  save(datExpr, datMeta, GO_neuronal, SFARI_genes, DE_info, file='./../Data/Voineagu_normalised.RData')
  
} else load('./../Data/Voineagu_normalised.RData')

datExpr_backup = datExpr

DE_info = DE_info %>% mutate('logFC'= Fold.Change, 'ID' = Gene.Name)

datMeta = datMeta %>% mutate('Diagnosis_' = ifelse(A.C=='A','autism','control'))
...
if(!file.exists('./../Data/Voineagu_combat.RData')){
  ...
  save(datExpr, datMeta, GO_neuronal, SFARI_genes, DE_info, file='./../Data/Voineagu_combat.RData')
  
} else load('./../Data/Voineagu_combat.RData')
