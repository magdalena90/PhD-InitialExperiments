...
- Only 621 genes (~4% vs ~26% in Gandal's dataset) are significant using a threshold of 0.05 for the adjusted p-value and a without a log Fold Change threshold (keeping the null hypothesis $H_0: lfc=0$)
...
- There is a clear negative relation between lfc and mean expression, specially for differentially expressed genes
