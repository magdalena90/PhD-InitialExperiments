...
**Note:** Using the threshold of 5, when calculating the DE genes with the DESeq function, over 200 rows do not converge, which happenes when the filtering threshold is too low, so because of this, the threshold was increased to 6.
