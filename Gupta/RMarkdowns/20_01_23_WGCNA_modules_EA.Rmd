...
```{r plot_heatmap, fig.width=10, fig.height=20}
...
- SFARI scores 3 to 5 have a lower median than all genes that have a neuronal-related annotation <span style="color:'red'>!</span>
...
- SFARI score 5 is the group with the lowest Gene Significance, with the same median than the genes without any type of Neuronal annotation <span style="color:'red'>!</span>
